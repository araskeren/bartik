					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label for="nama" class="col-sm-3 control-label">Jenis</label>
							 <div class="col-sm-9">
								 <input type="text" class="form-control" id="nama" placeholder="Kategori" name="nama" value="{{$jenis->nama}}" required>
							 </div>
						</div>
						<div class="form-group">
					    <div class="col-sm-offset-10 col-sm-2">
					      <button type="submit" class="btn btn-primary" name="Tambah" value="simpan">Simpan</button>
					    </div>
						</div>
					</div>
						<div class="col-lg-6">
